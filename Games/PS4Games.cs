...
namespace PersonaGameLib
{
    public partial class Games
    {
        public static List<Game> PS4Games = new List<Game>()
        {
            ...
            new Game() { Name = "Persona 3 Dancing in Moonlight", ShortName = "P3D", TitleID = "CUSA12636", Region = "USA",
            ...
            new Game() { Name = "Persona 3 Dancing in Moonlight", ShortName = "P3D", TitleID = "CUSA12810", Region = "EUR",
                Patches = Patches.PS4P3DUSAPatches,
                Platform = "PS4",
                UpdatePKGMinSize = 13631488, UpdatePKGName = "EP2475-CUSA12810_00-PERSONA3DEU00000-A0101-V0100.pkg",
                ImageUrl = "https://cdn.mobygames.com/covers/7364420-persona-3-dancing-in-moonlight-front-cover.jpg" },

            new Game() { Name = "Persona 4 Dancing All Night", ShortName = "P4D", TitleID = "CUSA12811", Region = "EUR",
            ...
            new Game() { Name = "Persona 5 Dancing in Starlight", ShortName = "P5D", TitleID = "CUSA12380", Region = "USA",
            ...
            new Game() { Name = "Persona 5 Dancing in Starlight", ShortName = "P5D", TitleID = "CUSA12813", Region = "EUR",
                Patches = Patches.PS4P5DUSAPatches,
                Platform = "PS4",
